...
function Interactive({ id }) {
  ...
  const interativeDetails = [
    ...
    [
      "Image Pins",
      "Allows the user to place pins on an image to highlight points of interest. Note you can specify an image URL, as shown in the Image Reveal interactive, or your own image in base64 format as shown below. You can convert local images to base64 using a tool like https://www.base64-image.de/ or https://base64.guru/converter/encode/image.",
